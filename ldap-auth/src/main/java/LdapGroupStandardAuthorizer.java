 ...
 * NOTE!
 *
 * This class does not support DENY rules! It will call the original StandardAuthorizer first, and
 ...
 * membership!
 *
 * The reason for this is that when we process the results of the original StandardAuthorizer,
 ...
 */
public final class LdapGroupStandardAuthorizer
